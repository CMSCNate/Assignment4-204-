...
public class CourseDBStructure_STUDENT_Test {
		...
		public void testHashTable() {
			...
			//Create a course 
			CourseDBElement cde1 = new CourseDBElement("ART1010", 243131, 2, "SC100", "Micheal Jackson");
			...
			CourseDBElement cde2 = new CourseDBElement("SPAN600", 4000, 4, "SW216", "Useless Man");
		 
	 		try {
				assertEquals(243131, cds.get(cde1.getCRN()).getCRN());  
			...
			CourseDBElement cde1Update = new CourseDBElement("CMSC500-updated", 243131, 4, "SC100", "updated");
			cds.add(cde1Update);  //Same CRN updated information
	 		courseList = cds.showAll(); 
			assertTrue(courseList.size()==2);  
			
			try {
				assertEquals(243131, cds.get(cde1Update.getCRN()).getCRN());
